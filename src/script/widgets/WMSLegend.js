 ...
 */
gxp.WMSLegend = Ext.extend(GeoExt.LayerLegend, {
    ...
    initComponent: function() {
        gxp.WMSLegend.superclass.initComponent.call(this);
    ...
    update: function() {
        ...
        gxp.WMSLegend.superclass.update.apply(this, arguments);
    ...
    beforeDestroy: function() {
        ...
        gxp.WMSLegend.superclass.beforeDestroy.apply(this, arguments);
    }
...
Ext.reg('gxp_wmslegend', gxp.WMSLegend);
